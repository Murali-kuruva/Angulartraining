...
export class SimpleBook1ServiceService {
  private books:Book[];
  public alladata:any[];
  ...
  addBook(book){
    ...
    this.http.post('http://localhost:1000/api/books',JSON.stringify(book),{ headers: headers });
  ...
  getBooks() {
      ...
      // return this.books;
        ...
        return this.http.get('http://localhost:1000/api/books');
  }
  ...
  getBook(isbn) {
    debugger;
       ...
       return this.http.get('http://localhost:1000/api/books/'+isbn,{ headers: headers });
